...
//       message: "A320neo has technical issues for flight 6E101",
//       icon: <Wrench className="h-4 w-4" />
//     },
//     {
//       title: "Compliance Check",
//       description: "Verify DGCA rules",
//       message: "Check DGCA compliance for current roster",
...
//           flight_number: disruptionForm.flight_number || undefined,
...
//           disabled={!disruptionForm.crew_id || !disruptionForm.start_date}
//         >
//           Analyze Disruption
//         </Button>
//       </CardContent>
...
//                     variant="outline"
//                     size="sm"
//                     onClick={() => setCurrentMessage('JCC001 called in sick for flight 6E101')}
//                     className="text-xs h-7"
//                   >
//                     Report Sickness
//                   </Button>
...
//                       onClick={() => setCurrentMessage(scenario.message)}
//                     >
  ...
  const handleApplyReplacement = async (flightNumber: string, originalCrew: string, newCrew: string) => {
    ...
    try {
      ...
      if (data.status === 'success') {
        ...
        // Refresh the disruption analysis to show updated status
